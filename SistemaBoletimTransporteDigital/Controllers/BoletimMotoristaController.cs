...
namespace SistemaBoletimTransporteDigital.Controllers
{
    public class BoletimMotoristaController : Controller
    {
        ...
        public BoletimMotoristaController(ICorridaRepositorio corridaRepositorio, ISessao sessao, IVeiculoRepositorio veiculoRepositorio,
        ...
        public async Task<IActionResult> Index(DateTime dataInicio, DateTime dataFinal, BoletimViewModel model)
        {
            ...
            int usuarioId = model.UsuarioId;

            var usuarioid =_corridaRepositorio.BuscarCorrida(usuarioId);
        ...
        public async Task<IActionResult> BoletimMotoristaPdf(DateTime dataInicio, DateTime dataFinal, int veiculoId, int usuarioId)
        {
            ...
            var pdfOptions = new ViewAsPdf("BoletimMotoristaPdf", viewModel)
            {
        ...
        public IActionResult SelecaoMotorista(BoletimViewModel model)
        {
            ...
            var viewModel = new BoletimViewModel
            {
                ...
                DadosUsuario = _usuarioRepositorio.BuscarUsuario()
            };

            return View(viewModel);
        }
        
        public async Task<IActionResult> ManutencaoVeiculo(DateTime dataInicio, DateTime dataFinal, int veiculoId, int usuarioId)
        {
